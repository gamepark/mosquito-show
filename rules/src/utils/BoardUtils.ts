...
export function removeMosquitoFromPlayer(game: GameState | GameView, mosquitoIndex: number | undefined) {
  if (mosquitoIndex !== undefined) {
...
export function tokenForcedToReveal(game: GameState | GameView, x: number, y: number) {
